...
import {SOCIAL_EVENTS_MOCK} from '../socialEvent/Mocks.js'
import {SOCIAL_EVENTS_MOCK2} from '../socialEvent/events-mock.js'

import {DBServices} from './DBServices'
import {LocationServices} from '../location/services/LocationServices'
import {DEFAULTS_VALUES_MOCK} from '../socialEvent/defaults-values-mock.js'
...
export class GetDataServices {
  constructor(){
    ...
    this.getSocialEvents = () =>{
      //Array that contain all data of categories
      let socialEventsData = {};
      let dataName = "socialEvents";
      /*
      //DB Service Object
      let dbService = new DBServices();
      ...
      */
      ...
      const socialEventsDataArr = Array.from(SOCIAL_EVENTS_MOCK2);
      //Adding deleted/default Category
      //socialEventsDataArr.push([this.locationServices.defaultId,"Default/Deleted Category"]);

      const socialEventsDataMap = new Map(socialEventsDataArr);
      return {arr : socialEventsDataArr, map: socialEventsDataMap};



    }

    this.getFakeData2 = (dataName) => {
      let obj = {name: "xxx", a:"ad"};/*
      if (dataName === 'DEFAULT_EVENT_PROPERTIES')
      obj = DEFAULTS_VALUES_MOCK;
      */
      //return  LOCATIONS_MOCK ;
      return   DEFAULTS_VALUES_MOCK;
    }

  }

  static getFakeData(dataName) {
    if (dataName === 'DEFAULT_EVENT_PROPERTIES')
